...
ReadiumSDK.Views.ReflowableView = Backbone.View.extend({
    ...
    updateHtmlFontSizeAndColumnGap: function() {
        ...
        if(this.$epubHtml) {
            ...
            this.$epubHtml.css("column-gap", this.paginationInfo.columnGap + "px");
        }
    },
    ...
    onIFrameLoad : function(success) {
        ...
        this.$epubHtml.css("column-axis", "horizontal");
...
//                  $epubHtml.css("background-color", '#b0c4de');
        ...
        //this.$epubHtml.css("column-rule-color", "red");
        //this.$epubHtml.css("column-rule-style", "dashed");
        //this.$epubHtml.css("background-color", '#b0c4de');
...
//                $('default', this).prop("hidden", true);
    ...
    onPaginationChanged: function(initiator, paginationRequest_spineItem, paginationRequest_elementId) {
        ...
        //alert(this.paginationInfo.columnWidth);
        //alert(this.paginationInfo.columnGap);
        //alert(this.paginationInfo.visibleColumnCount);
        //alert(this.paginationInfo.currentSpreadIndex);
    ...
    openPageNext: function (initiator) {
        ...
        alert("this.currentSpineItem:" + this.currentSpineItem);
        if (!this.currentSpineItem) {
            return;
        }
        alert("before this.paginationInfo.currentSpreadIndex:" + this.paginationInfo.currentSpreadIndex);
        ...
        alert("after this.paginationInfo.currentSpreadIndex:" + this.paginationInfo.currentSpreadIndex);
    },
    ...
    updatePagination: function() {
        ...
        this.$epubHtml.css("column-width", this.paginationInfo.columnWidth + "px");
