...
ReadiumSDK.Views.ReaderView = function(options) {
    ...
    function renderCurrentView(isReflowable) {
        ...
        if(isReflowable) {
            ...
            //alert("new ReadiumSDK.Views.ReflowableView(viewCreationParams);");
            _currentView = new ReadiumSDK.Views.ReflowableView(viewCreationParams);
        }
        else {
            //alert("ReadiumSDK.Views.FixedView(viewCreationParams);");
    ...
    this.openBook = function (openBookData) {
        //alert("openBook:" + JSON.stringify(openBookData));
