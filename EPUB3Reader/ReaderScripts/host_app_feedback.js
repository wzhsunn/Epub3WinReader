...
ReadiumSDK.HostAppFeedback = function() {
    ...
    this.onPaginationChanged = function(paginationInfo) {
        ...
        if (external) {
            ...
            //if (external.onIsMediaOverlayAvailable) 
		{
                external.onIsMediaOverlayAvailable(ReadiumSDK.reader.isMediaOverlayAvailable());
            }
        }
	...
	//if(external && external.onMediaOverlayStatusChanged) 
	{
    ...
    this.onMediaOverlayTTSSpeak = function(tts) {
        ...
        //}
        //if (external && external.onMediaOverlayTTSSpeak) 
	{
    ...
    this.onMediaOverlayTTSStop = function() {
        ...
        //}
        //if (external && external.onMediaOverlayTTSStop) 
	{
